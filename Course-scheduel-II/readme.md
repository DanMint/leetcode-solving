The first code that i pushed (first.cpp) was the code that i came up without thinking much about the style and the amount of time that it would tale for the program.
